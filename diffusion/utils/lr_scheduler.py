...
def build_lr_scheduler(config, optimizer, train_dataloader, lr_scale_ratio, num_processes):
    ...
    if config.lr_schedule == 'cosine':
        lr_scheduler = get_cosine_schedule_with_warmup(
            ...
            **config.lr_schedule_args,
            num_training_steps=(len(train_dataloader) * config.num_epochs) // num_processes,
        )
